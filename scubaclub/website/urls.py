...
urlpatterns = [
    ...
    path('club/<slug:club_slug>/edit/', views.edit_dive_club, name='edit_dive_club'),

    path(_('create_dive_event/'), views.create_dive_event, name='create_dive_event'),
    path(_('create_dive_event/<int:club_id>/'), views.create_dive_event,
    ...
    path('location/<int:location_id>/suggest_edit/', views.suggest_location_edit,
         name='suggest_location_edit'),
    path('review_location_suggestions/', views.review_location_suggestions,
         name='review_location_suggestions'),
    path('approve_suggestion/<int:suggestion_id>/', views.approve_location_suggestion,
         name='approve_location_suggestion'),
    path('reject_suggestion/<int:suggestion_id>/', views.reject_location_suggestion,
